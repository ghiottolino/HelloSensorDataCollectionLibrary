...
public class LocationListFragment extends ListFragment {
	...
	List<NormalizedSensorData> locations;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		locations = LocationLoggerService.getInstance().getLocations();
		
		setListAdapter(new ArrayAdapter<NormalizedSensorData>(getActivity(),
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(locations.get(position).id);
	}
